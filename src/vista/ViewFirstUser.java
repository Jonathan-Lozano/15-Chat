 ...
 *
 */
public final class ViewFirstUser extends JFrame {

	private static final ViewFirstUser vfu = new ViewFirstUser();
	 ...
	 * necesarios
	 */
	private ViewFirstUser() {
		super("Primer usuario");
	 ...
	 */
	public static ViewFirstUser getVfu() {
		return vfu;
	}

	/*
	 * Getters and Setters de elementos de la ventana
	 */
